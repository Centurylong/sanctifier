...
pub const DIVISION_BEFORE_MULTIPLICATION: &str = "SANCT_DIV_BEFORE_MUL";
...
pub fn all_finding_codes() -> Vec<FindingCode> {
    vec![
        ...
        FindingCode {
            code: DIVISION_BEFORE_MULTIPLICATION,
            category: "arithmetic",
            description:
                "Money-like integer math divides before multiplying and can lose precision",
        },
        FindingCode {
            code: SANCT_UNWRAP,
            category: "panic_handling",
...
mod tests {
    ...
    fn includes_expected_codes() {
        ...
        assert!(codes
            .iter()
            .any(|c| c.code == DIVISION_BEFORE_MULTIPLICATION));
