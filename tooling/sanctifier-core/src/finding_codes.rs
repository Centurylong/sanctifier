...
pub const ZERO_DENOMINATOR: &str = "SANCT_ZERO_DENOMINATOR";
...
pub fn all_finding_codes() -> Vec<FindingCode> {
    vec![
        ...
        FindingCode {
            ...
            category: "arithmetic",
            description:
                "Division or modulo operation uses a denominator without a visible zero guard",
        },
    ]
}
...
mod tests {
    ...
    fn includes_expected_codes() {
        ...
        assert!(codes.iter().any(|c| c.code == ZERO_DENOMINATOR));
    }
}
